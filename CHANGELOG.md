...
- Der Link zur Pächterregistrierung wird im Demo-Modus ausgeblendet.
- Die Login- und Projektbasis-Tests bestehen weiterhin mit 17 Tests und
  70 Assertions.
- Entwicklungsstand auf `0.2.0.75` erhöht.
- Entwicklungsstand `0.2.0.75` auf GitHub veröffentlicht.
...
- `laravel/ui` ist nun eine normale Composer-Abhängigkeit, weil OKGV
  `Auth::routes()` auch im Produktivbetrieb nutzt.
- Plesk kann dadurch `composer install --no-dev --optimize-autoloader`
  ausführen, ohne dass `artisan package:discover` wegen fehlender
  Auth-Routen-Unterstützung fehlschlägt.
- Die Produktionsinstallation ohne Dev-Pakete wurde mit anschließendem
  `artisan package:discover` geprüft.
- Insgesamt bestehen 203 Tests mit 1.221 Assertions.
- Composer-Abhängigkeiten weisen keine bekannten Sicherheitswarnungen auf.
- Entwicklungsstand auf `0.2.0.65` erhöht.
- Entwicklungsstand `0.2.0.65` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.64` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.63` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.62` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.61` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.60` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.59` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.57` auf GitHub veröffentlicht.
...
- Entwicklungsstand `0.2.0.56` auf GitHub veröffentlicht.
