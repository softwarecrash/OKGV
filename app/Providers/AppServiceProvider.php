...
use App\Policies\GardenInspectionPolicy;
use App\Policies\InventoryItemPolicy;
use App\Policies\InvoicePolicy;
use App\Policies\LetterPolicy;
use App\Policies\MailCampaignPolicy;
use App\Policies\MemberAssemblyPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(MemberAssembly::class, MemberAssemblyPolicy::class);
        ...
        Gate::policy(GardenInspection::class, GardenInspectionPolicy::class);
        Gate::policy(GardenInspectionFinding::class, GardenInspectionPolicy::class);
