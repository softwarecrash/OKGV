    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header"><h1 class="h4 mb-0">Meine Daten bearbeiten</h1></div>
                <div class="card-body">
                    <p class="text-secondary">Mitgliedsnummer, Mitgliedsstatus, Parzellen und Rechte werden durch den Verein verwaltet.</p>
                    ...
                    <form method="POST" action="{{ route('account.member-profile.update') }}">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button class="btn btn-primary" type="submit">Kontaktdaten speichern</button>
                            <a class="btn btn-outline-secondary" href="{{ route('account.member-profile.show') }}">Abbrechen</a>
                        </div>
                    </form>
                </div>
            </div>
