...
<div class="container">
    ...
    <div class="card border-0 shadow-sm"><div class="table-responsive"><table class="table align-middle mb-0">
        <thead><tr><th>Mitglied</th><th>Referenz</th><th>Konto</th><th>Gültigkeit</th><th>Status</th><th></th></tr></thead>
        <tbody>
        ...
        @empty
            <tr><td colspan="6" class="text-center py-4"><strong>Noch keine SEPA-Mandate.</strong><br><span class="text-secondary">Ein Mandat wird benötigt, bevor eine Rechnung per Lastschrift eingezogen werden kann.</span></td></tr>
        @endforelse
        </tbody>
    </table></div></div>
